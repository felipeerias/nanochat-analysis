---
source: d12-s9-s0-b872e698e81b4a8fa0cd08512f43c2c2
profile_spec: 1
...
- schema v3, seed 9, depth 12, width 768, heads 6
...
| sparse | 15,483 | 451 | 118 |
| offline | 15 | 0 | 15 |

## Summaries

- train loss: 10.3978 at the first step, 2.7744 at the last (2,520 points)
- final probe loss, train_stream: 2.8052
- final probe loss, val: 2.9143
- telemetry overhead: 551.7 s total; update_effectiveness 153.4 s, shadow_acceptance 149.8 s, calibration 124.4 s, lineage_inventory 38.0 s, noise 21.9 s
...
| shadow_fp32 | gradient | {'inconclusive': 5, 'passed': 25} |
...
- Undefined rows are present and carry reasons: 737 periodic, 451 sparse. They are honest 'not measurable here' records, not missing data.
